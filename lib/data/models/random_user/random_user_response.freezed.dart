...
mixin _$RandomUserResponse {
  List<RandomUser> get results => throw _privateConstructorUsedError;
...
abstract class $RandomUserResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<RandomUser> results});
}
...
class _$_RandomUserResponse implements _RandomUserResponse {
  const _$_RandomUserResponse({required final List<RandomUser> results})
      : _results = results;

  factory _$_RandomUserResponse.fromJson(Map<String, dynamic> json) =>
      _$$_RandomUserResponseFromJson(json);

  final List<RandomUser> _results;
  @override
  List<RandomUser> get results {
...
abstract class _RandomUserResponse implements RandomUserResponse {
  const factory _RandomUserResponse({required final List<RandomUser> results}) =
